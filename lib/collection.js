...
var callbackWrapForCursor = function (collection, resolve, reject) {
  return function (err, response) {
    if (!err) {
      return resolve(new Cursor(response, collection.client, collection));
    }
 ...
 */
Collection.prototype.insert = function (insertor) {
  if (!insertor) {
 ...
 */
Collection.prototype.delete = function (matcher, hint) {
  matcher = matcher || {};
  hint = hint || {};
  ...
  return new Promise((resovle, reject) => {
    this.client.send(buff, message, callbackWrap(resovle, reject));
  });
};
...
Collection.prototype.query = function (matcher, selector, orderBy, hint,
  ...
  if (arguments.length === 0) {
    ...
    // query(matcher, selector, orderBy, hint)
    skipRows = Long.ZERO;
    returnRows = Long.NEG_ONE;
    flag = 0;
  }
  ...
  return new Promise((resolve, reject) => {
    this.client.sendAdminCommand2(command, matcher, selector, orderBy, hint,
                              skipRows, returnRows, flag, callbackWrapForCursor(this, resolve, reject));
  });
};

Collection.prototype.update = function (flag, matcher, modifier, hint) {
 ...
 */
Collection.prototype.upsert = function (matcher, modifier, hint) {
  return this.update(constants.FLG_UPDATE_UPSERT, matcher, modifier, hint);
};
...
Collection.prototype.getIndexes = function () {
  ...
  return new Promise((resolve, reject) => {
    this.client.sendAdminCommand2(command, {}, {}, {}, hint, Long.NEG_ONE, Long.NEG_ONE, 0, callbackWrapForCursor(this, resolve, reject));
  });
};
...
Collection.prototype.getIndex = function (name) {
  ...
  return new Promise((resolve, reject) => {
    this.client.sendAdminCommand2(command, matcher, {}, {}, hint, Long.NEG_ONE, Long.NEG_ONE, 0, callbackWrapForCursor(this, resolve, reject));
  });
};
 ...
 */
Collection.prototype.createIndex = function (name, key, isUnique, isEnforced) {
  ...
  return new Promise((resolve, reject) => {
    this.client.sendAdminCommand2(command, matcher, {}, {}, {}, Long.NEG_ONE, Long.NEG_ONE, 0, callbackWrap(resolve, reject));
  });
};
 ...
 */
Collection.prototype.bulkInsert = function (insertors, flag) {
  ...
  return new Promise((resolve, reject) => {
    this.client.send(buff, message, callbackWrap(resolve, reject));
  });
};
...
Collection.prototype.explain = function (matcher, selector, orderBy, hint,
  ...
  return this.query(matcher, selector, orderBy, newHint, skipRows, returnRows, flag | Query.FLG_QUERY_EXPLAIN);
};
 ...
 */
Collection.prototype.count = function (matcher) {
  matcher || (matcher = {});
  ...
  return new Promise((resolve, reject) => {
    this.client.sendAdminCommand2(command, matcher, {}, {}, hint, Long.ZERO, Long.NEG_ONE, 0, function (err, response) {
      ...
      that.getMoreCommand(response, function (err, response) {
        ...
        resolve(response[0][constants.FIELD_TOTAL]);
      });
    });
  });
};
 ...
 */
Collection.prototype.aggregate = function (list) {
...
Collection.prototype.getQueryMeta = function (matcher, orderBy, hint,
  ...
  return new Promise((resolve, reject) => {
    this.client.sendAdminCommand2(command, matcher, hint, orderBy,
                        ...
                        callbackWrapForCursor(this, resolve, reject));
  });
};
 ...
 */
Collection.prototype.attachCollection = function (subClFullName, options) {
  // check argument
  ...
  return new Promise((resolve, reject) => {
    this.client.sendAdminCommand2(command, matcher, {}, {}, {}, Long.ZERO, Long.NEG_ONE, 0, callbackWrap(resolve, reject));
  });
};
 ...
 * @param subClFullName The name of the subcollection
 */
Collection.prototype.detachCollection = function (subClFullName) {
  // check argument
  if (!subClFullName || subClFullName.length > constants.COLLECTION_MAX_SZ) {
    throw new SDBError('SDB_INVALIDARG');
  }
 ...
 */
Collection.prototype.alter = function (options) {
  // check argument
  if (!options) {
    throw new SDBError('SDB_INVALIDARG');
  }
 ...
 */
Collection.prototype.getLobs = function () {
  var command = constants.ADMIN_PROMPT + constants.LIST_LOBS_CMD;
  var matcher = {};
  matcher[constants.FIELD_COLLECTION] = this.collectionFullName;
  // run command
  return new Promise((resolve, reject) => {
    this.client.sendAdminCommand2(command, matcher, {}, {}, {}, Long.ZERO, Long.NEG_ONE, 0, callbackWrapForCursor(this, resolve, reject));
  });
};
 ...
 */
Collection.prototype.createLob = function (id) {
  id = id || null;
  var lob = new Lob(this);

  return new Promise((resolve, reject) => {
    lob.open(id, Lob.SDB_LOB_CREATEONLY, function (err) {
      if (err) {
        return reject(err);
      }
      resolve(lob);
 ...
 */
Collection.prototype.openLob = function (id) {
  var lob = new Lob(this);
  return new Promise((resolve, reject) => {
    lob.open(id, Lob.SDB_LOB_READ, function (err) {
      if (err) {
        return reject(err);
      }
      resolve(lob);
 ...
 */
Collection.prototype.removeLob = function (id) {
  var matcher = {};
  matcher[constants.FIELD_COLLECTION] = this.collectionFullName;
